...
class Trainer(object):
    ...
    def test_(self,model_P):
        self.matcher.load_state_dict(self.de(torch.load(model_P)))
...
if __name__ == '__main__':
    ...
    for few in [1,5,10]:
        ...
        if few==1:
            trainer.test_('models/dataset1/models_drugbank_1shot_str/bestmodel')
        elif few==5:
            trainer.test_('models/dataset1/models_drugbank_5shot_str/bestmodel')
        elif few==10:
            trainer.test_('models/dataset1/models_drugbank_10shot_str/bestmodel')
        else:
            print("num_few error!")
