...
if __name__ == '__main__':
    ...
    for few in [1, 5, 10]:
        ...
        if few == 1:
            trainer.test_('models/dataset2/models_mdf_1shot_str/bestmodel')
        elif few == 5:
            trainer.test_('models/dataset2/models_mdf_5shot_str/bestmodel')
        elif few == 10:
            trainer.test_('models/dataset2/models_mdf_10shot_str/bestmodel')
        else:
            print("num_few error!")
