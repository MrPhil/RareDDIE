...
class Trainer(object):
    ...
    def test_(self):
        self.matcher.load_state_dict(self.de(torch.load('models/dataset1/bestmodels')))
        self.G_m=torch.load('models/dataset1/bestmodels_G')
        self.D_m=torch.load('models/dataset1/bestmodels_D')
