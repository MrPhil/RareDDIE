...
class Args(Tap):
    data_path: str='./data/drug_smiles.csv'  # Path to data CSV
    ...
    save_path: str='./features/morgan_dataset1.npz'  # Path to .npz file where features will be saved as a compressed numpy archive
