...
from data_preprocessing_t_twoside import *
class PairData(Data):
...
def train_generate(dataset, batch_size, few, symbol2id, ent2id, e1rel_e2, all_drug_data, drug_num_node_indices):
    ...
    while True:
        ...
        # support_batch = drug_structure_construct_peb(support_triples_rel2id)
        ...
        # query_batch = drug_structure_construct_peb(query_triples_rel2id)
        ...
        # false_batch = drug_structure_construct_peb(false_triples_rel2id)
