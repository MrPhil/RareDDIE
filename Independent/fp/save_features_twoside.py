...
class Args(Tap):
    data_path: str='./data/PubChem_SMLIES.csv'  # Path to data CSV
    smiles_column: str = 'CanonicalSMILES'  # Name of the column containing SMILES strings. By default, uses the first column.
    features_generator: str = 'morgan'  # Type of features to generate
    save_path: str='./features/morgan_twoside.npz'  # Path to .npz file where features will be saved as a compressed numpy archive
